 ...
 *
 * Loaded as <script type="module" src="twin-three.js"> in the HTML.
 * Exposes:
 *   window.initThreeJS(container)   — builds the scene inside the given DOM element
 *   window._dnaHighlight(idx)       — highlight a base-pair rung from React
 *   window._dnaClearHighlight()     — clear the highlight
 * Calls window._reactBoot() (or sets window._threeReady) when ready.
 */
...
/* ── Main init function ────────────────────────────────────────── */
window.initThreeJS = function (container) {
  /* Scene */
...
/* Signal to React that Three.js is ready */
if (window._reactBoot) window._reactBoot();
else window._threeReady = true;
