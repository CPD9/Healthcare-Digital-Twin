...
import { Activity, Dna, MessageSquareHeart, Search } from "lucide-react";
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="text-sm text-[#3c4f3d]/70">
                Digital Future Health Twin - baseline genomic workflow
              </p>
            </div>
        ...
        {selectedGene ? (
          ...
          <>
            <Card className="mb-6 border-none bg-white py-0 shadow-sm">
              ...
              <CardContent className="space-y-4 pb-4">
                <p className="text-sm text-[#3c4f3d]/80">
                  This baseline keeps the current Evo2 variant analysis flow and
                  frames it as the first live signal for your broader Twin
                  experience.
                </p>
                <div className="grid gap-3 md:grid-cols-3">
                  <div className="rounded-md border border-[#3c4f3d]/10 bg-[#e9eeea]/40 p-3">
                    ...
                    <p className="text-xs text-[#3c4f3d]/75">
                      Questionnaire and user context (next phase), with genome
                      and gene exploration as the current interactive entry
                      point.
                    </p>
                  </div>
                  <div className="rounded-md border border-[#3c4f3d]/10 bg-[#e9eeea]/40 p-3">
                    ...
                    <p className="text-xs text-[#3c4f3d]/75">
                      Variant scoring runs through the deployed Modal Evo2
                      endpoint and returns predicted impact plus confidence.
                    </p>
                  </div>
                  <div className="rounded-md border border-[#3c4f3d]/10 bg-[#e9eeea]/40 p-3">
                    <div className="mb-1 flex items-center gap-2 text-[#3c4f3d]">
                    ...
                    <p className="text-xs text-[#3c4f3d]/75">
                      Results become explainable signals that later feed your
                      future-self dialogue and behavior-change loop.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="mt-6 gap-0 border-none bg-white py-0 shadow-sm">
              <CardHeader className="pt-4 pb-2">
                <CardTitle className="text-sm font-normal text-[#3c4f3d]/70">
                  Build and Explore Twin Signals
                </CardTitle>
              </CardHeader>
              <CardContent className="pb-4">
                <Tabs
