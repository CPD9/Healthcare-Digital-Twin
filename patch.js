// patch remaining avatar chat changes
const fs = require('fs');
const f = 'c:/Users/kamsi/Desktop/twin/twin-frontend/src/App.jsx';
let t = fs.readFileSync(f, 'utf8');
const R = (o, n) => {
  const i = t.indexOf(o);
  if (i < 0) { process.stderr.write('NOT FOUND: ' + o.slice(0, 60) + '\n'); return; }
  t = t.slice(0, i) + n + t.slice(i + o.length);
};

// 2. Conditional class on avatar-hud-left + open stats fragment
R(
...
// 5. Ask TWIN about this - remove setChatOpen
R('; setChatOpen(true); }}>', '; }}>');
...
// 8. headerExtras for avatar - update with toggle buttons
R(
